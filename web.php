...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/add-loans', [LoanController::class, 'add'])->name('loan.add');
    Route::get('/edit-loans/{id}', [LoanController::class, 'edit'])->name('loan.edit');
    Route::post('/update-loans/{id}', [LoanController::class, 'update'])->name('loan.update');
    ...
    Route::get('/view-docements/{id}', [companyController::class, 'viewDocuments'])->name('docements.view');
    Route::get('/view-resume/{id}', [companyController::class, 'viewResume'])->name('resume.view');
    Route::get('/download/{file}', [companyController::class, 'download'])->name('download.doc');
    Route::get('/download-resume/{file}', [companyController::class, 'downloadResume'])->name('download.resume');


    Route::get('/add-Documents/{id}', [companyController::class, 'addDocuments'])->name('docements.add');

    
    Route::get('/add-multiple/{id}', [companyController::class, 'addMultipleDocs'])->name('add-multiple-files');


    Route::post('/documents/upload/{id}', [companyController::class, 'uploadDocuments'])->name('upload.document');
